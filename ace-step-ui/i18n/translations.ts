...
export const translations = {
  en: {
    ...
    // Username Modal
    welcomeTitle: 'Welcome to ProdIA pro',
    ...
    stemBackend: 'Separation Engine',
    stemUvrDesc: 'Multiple models available',
    stemQuality: 'Quality',
    stemQualityFast: 'Fast',
    stemQualityHigh: 'High',
    stemQualityMax: 'Maximum',
    stemModel: 'Model',
    stemProcessing: 'Separating...',
    stemProcessingHint: 'This may take a minute depending on the audio length',
    stemResults: 'Separated Stems',
    stemDownloadAll: 'Download All',
    stemNewSeparation: 'New Separation',
    stemSeparate: 'Separate Stems',
    stemSeparationFailed: 'Stem separation failed',
    stemUvr4NotSupported: 'UVR only supports 2-stem separation',
    stemRoformerDownloadNote: 'RoFormer models (~400MB) are downloaded automatically on first use. The first separation may take longer.',
    stemDepsChecking: 'Checking dependencies…',
    stemDepsMissing: 'Package "{{pkg}}" is not installed. Install it to use this engine.',
    stemDepsInstall: 'Install {{pkg}}',
    stemDepsInstalling: 'Installing…',
    stemDepsReady: 'Dependencies ready',
    stemInstallFailed: 'Installation failed. Check the server logs.',
  ...
  zh: {
    ...
    stemModel: '模型',
    stemProcessing: '分离中...',
    stemProcessingHint: '根据音频长度可能需要一分钟',
    stemResults: '分离的音轨',
    stemDownloadAll: '全部下载',
    stemNewSeparation: '重新分离',
    stemSeparate: '分离音轨',
    stemSeparationFailed: '音轨分离失败',
    stemUvr4NotSupported: 'UVR仅支持2音轨分离',
    stemRoformerDownloadNote: 'RoFormer模型（约400MB）会在首次使用时自动下载。首次分离可能需要更长时间。',
    stemDepsChecking: '正在检查依赖项…',
    stemDepsMissing: '未安装包 "{{pkg}}"。请安装以使用此引擎。',
    stemDepsInstall: '安装 {{pkg}}',
    stemDepsInstalling: '正在安装…',
    stemDepsReady: '依赖项已就绪',
    stemInstallFailed: '安装失败。请检查服务器日志。',
    reusePrompt: '重用提示词',
    deleteSong: '删除歌曲',
    useAsReference: '用作参考',
    coverSong: '翻唱歌曲',
  ...
  ja: {
    ...
    stemModel: 'モデル',
    stemProcessing: '分離中...',
    stemProcessingHint: '音声の長さによっては1分程度かかる場合があります',
    stemResults: '分離されたステム',
    stemDownloadAll: 'すべてダウンロード',
    stemNewSeparation: '新規分離',
    stemSeparate: 'ステムを分離',
    stemSeparationFailed: 'ステム分離に失敗しました',
    stemUvr4NotSupported: 'UVRは2ステム分離のみ対応',
    stemRoformerDownloadNote: 'RoFormerモデル（約400MB）は初回使用時に自動ダウンロードされます。初回の分離には時間がかかる場合があります。',
    stemDepsChecking: '依存関係を確認中…',
    stemDepsMissing: 'パッケージ「{{pkg}}」がインストールされていません。このエンジンを使用するにはインストールしてください。',
    stemDepsInstall: '{{pkg}} をインストール',
    stemDepsInstalling: 'インストール中…',
    stemDepsReady: '依存関係は準備完了',
    stemInstallFailed: 'インストールに失敗しました。サーバーログを確認してください。',
  ...
  ko: {
    ...
    // Username Modal
    welcomeTitle: 'ProdIA pro에 오신 것을 환영합니다',
    ...
    stemModel: '모델',
    stemProcessing: '분리 중...',
    stemProcessingHint: '오디오 길이에 따라 1분 정도 소요될 수 있습니다',
    stemResults: '분리된 스템',
    stemDownloadAll: '모두 다운로드',
    stemNewSeparation: '새로 분리',
    stemSeparate: '스템 분리',
    stemSeparationFailed: '스템 분리 실패',
    stemUvr4NotSupported: 'UVR은 2스템 분리만 지원합니다',
    stemRoformerDownloadNote: 'RoFormer 모델(~400MB)은 처음 사용 시 자동으로 다운로드됩니다. 첫 번째 분리에는 더 오래 걸릴 수 있습니다.',
    stemDepsChecking: '종속성 확인 중…',
    stemDepsMissing: '패키지 "{{pkg}}"가 설치되지 않았습니다. 이 엔진을 사용하려면 설치하세요.',
    stemDepsInstall: '{{pkg}} 설치',
    stemDepsInstalling: '설치 중…',
    stemDepsReady: '종속성 준비 완료',
    stemInstallFailed: '설치에 실패했습니다. 서버 로그를 확인하세요.',
