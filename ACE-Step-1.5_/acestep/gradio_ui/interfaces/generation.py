    ...
    with gr.Group():
        ...
        with gr.Accordion(t("service.title"), open=accordion_open, visible=accordion_visible) as service_config_accordion:
            ...
            with gr.Row():
                ...
                # Default to False since torchao may not be installed in portable builds
                _has_torchao = False
                try:
                    import torchao
                    _has_torchao = True
                    ...
                    pass
                quantization_value = init_params.get('quantization', _has_torchao) if service_pre_initialized else _has_torchao
            ...
            with gr.Row():
                lora_path = gr.Textbox(
                    label="LoRA Path",
                    placeholder=r"C:\Users\...\checkpoints\epoch_90  or  ./lora_output/final/adapter",
                    info="Full path to LoRA adapter directory (auto-searches subdirectories for adapter_config.json)",
                    scale=3,
                )
